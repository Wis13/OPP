...
public class GradeBook {
    ...
    private static void varArgs() {
        ...
        System.out.println("Averege of 2 elements " + calcAverage(a, b));
        System.out.println("Averege of 3 elements " + calcAverage(a, b, d));
        System.out.println("Averege of 4 elements " + calcAverage(a, b, c, d));
